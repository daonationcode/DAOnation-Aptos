...
contract DAOnation  {
    ...
    function join_community(uint256 dao_id,  string memory person) public {
        ...
        _joined_person[_join_ids] = join_struct({
            daoid:dao_id,
            wallet:person
        });
        _join_ids++;
    ...
    function addTempData() public{
        create_dao("TSm2NsA2W69XruNCbsuK9ozzVqe3gWm3G1","{\"title\":\"Asset Metadata\",\"type\":\"object\",\"properties\":{\"Title\":{\"type\":\"string\",\"description\":\"Lake Nona, Orlando US\"},\"Description\":{\"type\":\"string\",\"description\":\"\"},\"Start_Date\":{\"type\":\"string\",\"description\":\"2023-08-16T11:14\"},\"logo\":{\"type\":\"string\",\"description\":{\"url\":\"https://bafybeicb5yy36ocs4yulph6zpx7ggsyeginsjwnft7ml7cxojywpbsjuq4.ipfs.nftstorage.link\",\"type\":\"image/png\"}},\"wallet\":{\"type\":\"string\",\"description\":\"TSm2NsA2W69XruNCbsuK9ozzVqe3gWm3G1\"},\"SubsPrice\":{\"type\":\"number\",\"description\":\"0.05\"},\"typeimg\":{\"type\":\"string\",\"description\":\"Dao\"},\"allFiles\":[{\"url\":\"https://bafybeicb5yy36ocs4yulph6zpx7ggsyeginsjwnft7ml7cxojywpbsjuq4.ipfs.nftstorage.link\",\"type\":\"image/png\"}]}}", 
...
create_goal("{\"title\":\"Asset Metadata\",\"type\":\"object\",\"properties\":{\"Title\":{\"type\":\"string\",\"description\":\"Renewable energy\"},\"Description\":{\"type\":\"string\",\"description\":\"Our DAO is starting it's own renewable energy company that delivers energy for the whole community\"},\"Budget\":{\"type\":\"string\",\"description\":\"$1,000,000\"},\"End_Date\":{\"type\":\"string\",\"description\":\"2023-08-31T22:40\"},\"wallet\":{\"type\":\"string\",\"description\":\"TSm2NsA2W69XruNCbsuK9ozzVqe3gWm3G1\"},\"logo\":{\"type\":\"string\",\"description\":{\"url\":\"https://bafybeic5g4xvj7myrgkb62lenld7orpl2hrspmzlzcdbzpyotc33tqygpe.ipfs.nftstorage.link\",\"type\":\"image/jpeg\"}},\"allFiles\":[{\"url\":\"https://bafybeic5g4xvj7myrgkb62lenld7orpl2hrspmzlzcdbzpyotc33tqygpe.ipfs.nftstorage.link\",\"type\":\"image/jpeg\"}]}}",0);
    string[] memory row;
    create_ideas("{\"title\":\"Asset Metadata\",\"type\":\"object\",\"properties\":{\"Title\":{\"type\":\"string\",\"description\":\"Solar panels on the Consequences Nona community center \"},\"Description\":{\"type\":\"string\",\"description\":\"We can ins\\n\"},\"StructureLeft\":{\"type\":\"string\",\"description\":[\"Representatives Berlin\",\"Community\",\"Children\"]},\"StructureRight\":{\"type\":\"string\",\"description\":[\"20%\",\"70%\",\"10%\"]},\"Qoutation\":{\"link\":\"https://uploadify.net/5273d350dfd001d1/quotation_Consequences_Nona_community_center.pdf\",\"prize\":\"$48,071.55\"},\"wallet\":{\"type\":\"string\",\"description\":\"TUAueT8ecFx5MydH9XYJh8rt83MN8FRbhw\"},\"logo\":{\"type\":\"string\",\"description\":{\"url\":\"https://bafybeif4fk6twikkcyopglhppdo7dd3l34bm6qedje3mxftec5e7b4he54.ipfs.nftstorage.link\",\"type\":\"image/png\"}},\"allFiles\":[{\"url\":\"https://bafybeif4fk6twikkcyopglhppdo7dd3l34bm6qedje3mxftec5e7b4he54.ipfs.nftstorage.link\",\"type\":\"image/png\"}]}}",0,row);
