...
export default function Welcome() {
  ...
  function letstartCLICK() {
    ...
    } else if (window?.tronWeb?.defaultAddress?.base58.toString().toLocaleLowerCase().toString() == null || window.localStorage.getItem("login-type") === "tronlink") {
    ...
    <>
      ...
      <div className={styles.section}>
        <div className={styles.text}>
          ...
          <p className="py-4">
            DAOnation is an innovative Software-as-a-Service (SaaS) platform designed to empower communities with trust through the utilization of a decentralized autonomous organization (DAO) framework. DAOnation is built on the Aptos infrastructure with the principles of transparency, collaboration, and fairness. DAOnation enables communities to govern themselves, make decisions collectively, have a transparency payments process and build trust-based ecosystems. Everything in just a couple clicks. Start your DAO today and give everyone in your community a voice.
