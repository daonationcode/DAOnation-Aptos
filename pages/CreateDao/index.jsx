...
export default function CreateDao() {
  ...
  async function createDao() {
    ...
    for (let index = 0; index < DaoImage.length; index++) {
      ...
      // };
      const urlImageDao = {
          url: "https://th.bing.com/th/id/OIP.8EqUdFXMeB97k3EXPh0KAwHaEo?rs=1&pid=ImgDetMain",
          type: "png",
        };
    ...
    try {
      ...
      // Creating Dao in Smart contract from tronlink chain
      await sendTransaction("create_dao",[signerAddress, JSON.stringify(createdObject), formatted_template]);
